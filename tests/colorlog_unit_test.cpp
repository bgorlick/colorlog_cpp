...
// Function to test the concepts directly
void test_concepts() {
    ...
    static_assert(!PrintableStringOrIterableOrOptional<std::optional<std::vector<int>>>);
    static_assert(PrintableOrException<std::string>);
    static_assert(!PrintableOrException<std::vector<int>>);
    static_assert(!PrintableStringOrIterable<int>); // Error here
    static_assert(PrintableStringOrIterableOrOptional<std::optional<std::string>>); // YOU FIXED THIS ONE
    static_assert(PrintableStringOrIterableOrOptional<std::optional<int>>); // YOU FIXED THIS ONE
    static_assert(PrintableOrException<std::runtime_error>); // YOU FIXED THIS ONE
